  ...
  return (
    <>
      ...
      <div className="container mt-4 mt-md-5 mb-5">
        ...
        <div className="hero-gradient-bg mb-5 p-3 p-md-4">
        ...
        {/* 🔥 STATS SECTION - dynamic with icons & hover effect */}
        ...
        {/* 🔥 TEAM SECTION - professional bio & social links */}
            ...
            {teamData.map((member) => (
              <div key={member.id} className="col-md-4">
                <div className="card border-0 shadow-sm rounded-4 p-4 text-center h-100 hover-lift">
                  <div className="img-hover-zoom mx-auto" style={{ width: "100px" }}>
                    <img
                      src={member.img}
        ...
        {/* 🔥 MISSION STATEMENT - extra real project touch */}
        <div className="row mb-5 align-items-center bg-light rounded-4 p-4 p-md-5 shadow-sm">
          <div className="col-md-8">
            ...
            <p className="text-muted mb-0">
              ...
              experience. We believe in transparency, speed, and building
        ...
        {/* 🔥 CTA SECTION - improved with dual action */}
        <div className="text-center py-4">
          <div className="bg-gradient-primary rounded-4 p-4 p-md-5" style={{ background: "linear-gradient(120deg, #f0f9ff, #e6f4ff)" }}>
            <h4 className="fw-bold display-6 fs-2">Ready to elevate your shopping experience?</h4>
...
//         console.log("ABOUT API 👉", res.data);
...
//       <h2 className="text-center fw-bold">{data.title}</h2>
...
//             <h4 className="text-primary">{s.value}</h4>
//             <p>{s.label}</p>
//           </div>
//         ))}
//       </div>
